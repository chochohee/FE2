console.log("=== Set ===");
const s = new Set([10, 20, 30, 30, 20, 10]); // 10,20,30 // 값이 중복되더라도 유일한 값만 가져옴
console.log(s);
...
console.log(str); // 'a','b','c','e'
console.log(str.size); // 4
...
console.log("2.합집합 : 두 집합의 모든 요소를 포함하는 집합");
